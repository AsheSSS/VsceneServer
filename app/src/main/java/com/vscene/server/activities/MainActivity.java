...
package com.vscene.server.activities;
...
import com.vscene.server.FsApp;
import com.vscene.server.ftpserver.FsService;
import com.vscene.server.ftpserver.FsSettings;
import com.vscene.server.server.R;
import com.vscene.server.socketserver.services.SocketService;
...
public class MainActivity extends PreferenceActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Preference chat = findPref("chat");
        chat.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
//                Intent
//                AlertDialog ad = new AlertDialog.Builder(MainActivity.this)
